  ...
  <div class="content-wrapper">
    ...
    <a href="../class study/m1_4.php"><small>(ม.1/4)</a></small>
         <a href="../class study/m1_5.php"><small>(ม.1/5)</a></small>
                 <a href="../class study/m1_6.php"><small>(ม.1/6)</a></small>
                <small><b> <a href="../class study/m1_7.php">(ม.1/7)</a></b></small>
      </h1>
...
$query = "SELECT id_std,teacher
                        FROM student
                         where class_room= 'ม.1/7'
                        ORDER BY id_std";
$query_num = mysqli_query($con, $query);
$row = mysqli_num_rows($query_num);
echo ' รายชื่อนักเรียนทั้งหมด   ( ' . $row . ' คน )  '; 
?> <?php
$strSQL = "SELECT * FROM student  where class_room= 'ม.1/7'  ";
  $objQuery = mysql_query($strSQL);
  $objResult = mysql_fetch_array($objQuery);
?> ครูประจำชั้น
...
if ($result = $db->query($strSQL)) {
    ...
    <td>  
       ...
       <a href="../function/edit_profile1.php?id=<?php echo $objResult->id_std; ?>" class="btn btn-primary btn-xs">
                       แก้ไขประวัติ</a>
                
      <a href="../function/delete_std1.php?id=<?php echo $objResult->id_std; ?>" class="btn btn-danger btn-xs">
                       ลบข้อมูล</a>
