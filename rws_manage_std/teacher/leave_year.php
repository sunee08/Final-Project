...
mysqli_query($con, "SET NAMES 'utf8' ");
            ...
            $query = "     
       SELECT SUM(leaves.percent) AS percent, DATE_FORMAT(leaves.date_time, '%Y') AS date_time FROM leaves
...
;
  ...
  <div class="box-body">
    <table id="example2" class="table  table-hover" class="center">
       ...
       $strSQL = "
             SELECT SUM(leaves.percent) AS percent, DATE_FORMAT(leaves.date_time, '%Y') AS date_time,student.fullname,leaves.times FROM leaves
 LEFT JOIN student ON student.id_std = leaves.id_std
     WHERE leaves.id_std 
