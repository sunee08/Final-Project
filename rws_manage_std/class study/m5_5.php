 ...
 <i class="fa fa-book"></i>
  ...
  <div class="content-wrapper">
    ...
    <a href="../class study/m5_2.php" ><small>(ม.5/2)</small></a>
        <a href="../class study/m5_3.php" ><small>(ม.5/3)</small></a>
           <a href="../class study/m5_4.php"><small>(ม.5/4)</small></a>
           <small><b>  <a href="../class study/m5_5.php">(ม.5/5)</small></b></a>
...
$query = "SELECT id_std,teacher
                        FROM student
                         where class_room= 'ม.5/5'
                        ORDER BY id_std";
$query_num = mysqli_query($con, $query);
$row = mysqli_num_rows($query_num);
echo ' รายชื่อนักเรียนทั้งหมด   ( ' . $row . ' คน )  '; 
?> <?php
$strSQL = "SELECT * FROM student  where class_room= 'ม.5/5'  ";
  $objQuery = mysql_query($strSQL);
  $objResult = mysql_fetch_array($objQuery);
?> ครูประจำชั้น
