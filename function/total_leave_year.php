...
<div class="container">
 ...
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
      <a href="../teacher/show_leaves.php?id=<?php echo $objectResult->id_std; ?>" class="btn btn-info">รายวัน</a> 
...
mysqli_query($con, "SET NAMES 'utf8' ");
   ...
   $my_id = $_GET['id'];
$query = "
             SELECT SUM(leaves.times_leaves) AS times_leaves, DATE_FORMAT(leaves.date_time, '%Y') AS date_time,student.fullname,leaves.times FROM leaves
 LEFT JOIN student ON student.id_std = leaves.id_std
     WHERE leaves.id_std ='$my_id'
     GROUP BY DATE_FORMAT(leaves.date_time, '%Y') DESC
            ";      
            ...
            ?>
                        <h3 align="center">รายงานแยกตามปี (ใบลา)</h3>
            ...
            <p align="center">
                ...
                datasets: [{
                label: 'รายงานรายได้ แยกตามปี(ใบลา)',
    ...
    <table id="example1" class="table  table-hover" class="center">
          <thead class="thead-light">
             ...
             <th style="font-size: 14px; color:white;" width="5%" class="text-left">ลำดับ</th>
              <th style="font-size: 14px; color:white;" width="15%" class="text-left">ปี</th>
                            <th style="font-size: 14px; color:white;" width="15%" class="text-left">ร้อยละ</th>
    ...
    while ($objResult = $result->fetch_object()) {
        ?>
         ...
         <td class="text-left" style="font-size: 15px;"><?php echo $objResult->date_time; ?></td>
           <td class="text-left" style="font-size: 15px;"><?php echo number_format($objResult->times_leaves); ?></td>
