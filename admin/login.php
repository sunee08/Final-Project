    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <br>
          ...
          <button type="submit" name="submit" class="btn btn-warning btn-block">เข้าสู่ระบบ</button>
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="register.html">สมัครสมาชิก</a>
          <!-- <a class="d-block small" href="forgot-password.html">Forgot Password?</a> -->
                      <a class="d-block small" href="../index2.php">หน้าแรก</a>
