    ...
    <section class="content-header">
      <h1>
        รายชื่อนักเรียน มัธยมศึกษาปีที่ 6
         ...
         <a href="../class study/m6_1.php"><small>(ม.6/1)</a></small>
     <small><b><a href="../class study/m6_2.php" >(ม.6/2)</small></b></a>
...
$query = "SELECT id_std,teacher
                        FROM student
                         where class_room= 'ม.6/2'
                        ORDER BY id_std";
$query_num = mysqli_query($con, $query);
$row = mysqli_num_rows($query_num);
echo ' รายชื่อนักเรียนทั้งหมด   ( ' . $row . ' คน )  '; 
?> <?php
$strSQL = "SELECT * FROM student  where class_room= 'ม.6/2'  ";
  $objQuery = mysql_query($strSQL);
  $objResult = mysql_fetch_array($objQuery);
?> ครูประจำชั้น
