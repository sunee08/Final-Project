 ...
 <i class="fa fa-book"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="../class study/m3_2.php" ><small>(ม.3/2)</a></small>
          <a href="../class study/m3_3.php" ><small>(ม.3/3)</a></small>
          <a href="../class study/m3_4.php"><small>(ม.3/4)</a></small>
           <a href="../class study/m3_5.php"><small>(ม.3/5)</a></small>
                <a href="../class study/m3_6.php"><small>(ม.3/6)</a></small>
                <small><b><a href="../class study/m3_7.php">(ม.3/7)</a></b></small>
      </h1>
...
$query = "SELECT id_std,teacher
                        FROM student
                         where class_room= 'ม.3/7'
                        ORDER BY id_std";
$query_num = mysqli_query($con, $query);
$row = mysqli_num_rows($query_num);
echo ' รายชื่อนักเรียนทั้งหมด   ( ' . $row . ' คน )  '; 
?> <?php
$strSQL = "SELECT * FROM student  where class_room= 'ม.3/7'  ";
  $objQuery = mysql_query($strSQL);
  $objResult = mysql_fetch_array($objQuery);
?> ครูประจำชั้น
