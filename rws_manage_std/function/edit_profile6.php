  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
        <form action="check_edit6.php?id=<?php echo $_GET["id"]; ?>" name="fromEdit" method="post"
...
if ($result = $db->query($strSQL)) {
   ...
   <div class="modal-footer">
                 <a href="../class study/m6_1.php">   <button type="button" class="btn btn-default pull-left" data-dismiss="modal">ย้อนกลับ</button></a>
