...
if ($result = $db->query($strSQL)) {
    ...
    <div class="modal-footer">
                           <a href="../class study/m5_1.php"> <button type="button" class="btn btn-success pull-left" data-dismiss="modal">ย้อนกลับ</button></a>
            </div>
...
;
  border-color: #3c8dbc;
      ...
      <!-- /.row (main row) -->
   <form id="add" name="add" method="post" action="check_side_behavior5.php" enctype="multipart/form-data" onsubmit="return checkForm()"  > 
  <div class="box-body">
...
?>
          ...
          <form id="add" name="add" method="post" action="check_side_study5.php" enctype="multipart/form-data" onsubmit="return checkForm()"  > 
