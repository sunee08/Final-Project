  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
                <form action="check_edit_user.php?id=<?php echo $_GET["id"]; ?>" name="fromEdit" method="post"
...
if ($result = $db->query($strSQL)) {
     ...
     <table class="table table-hover">
                  ...
                  <img src="../dist/img/user1.png" width=150 height=150 >
                        ...
                        <tr>
                            ...
                            <td>  <?php echo $objectResult->fullname; ?>
                            </td>
                        </tr>
                        <tr>
                            <th align="right" scope="row">&nbsp;</th>
                            <th> ชื่อผู้ใช้</th>
                               <td>  <?php echo $objectResult->username; ?>
                            </td>
                        ...
                        <tr>
                            <th align="right" scope="row">&nbsp;</th>
                            <th> สถานะ</th>
                              <td>   <?php echo $objectResult->status; ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>อีเมล์</th>
                              ...
                              <td>   <?php echo $objectResult->email; ?>
                            </td>
 ...
 <tr>
                            ...
                            <th>เพศ</th>
                              ...
                              <td>   <?php echo $objectResult->gender; ?>
                            </td>
  ...
  <tr>
                            ...
                            <th>รหัสผ่าน</th>
                              ...
                              <td>  <?php echo $objectResult->password; ?>
                            </td>
