...
<li class="active treeview">
          ...
          <ul class="treeview-menu">
              ...
              <ul class="treeview-menu">
              <li class="active "><a href="../class study/m4_1.php"><i class="fa fa-circle-o"></i> ม.4</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a href="../class study/m4_1.php"><small>(ม.4/1)</a></small>
      <a href="../class study/m4_2.php"><small>(ม.4/2)</a></b></small>
      <a href="../class study/m4_3.php" ><small>(ม.4/3)</small></a>
        <a href="../class study/m4_4.php"><small>(ม.4/4)</small></a>
             <small><b>    <a href="../class study/m4_5.php">(ม.4/5)</small></b></a>
...
$query = "SELECT id_std,teacher
                        FROM student
                         where class_room= 'ม.4/5'
                        ORDER BY id_std";
$query_num = mysqli_query($con, $query);
$row = mysqli_num_rows($query_num);
echo ' รายชื่อนักเรียนทั้งหมด   ( ' . $row . ' คน )  '; 
?> <?php
$strSQL = "SELECT * FROM student  where class_room= 'ม.4/5'  ";
  $objQuery = mysql_query($strSQL);
  $objResult = mysql_fetch_array($objQuery);
?> ครูประจำชั้น
...
if ($result = $db->query($strSQL)) {
    ...
    <td>  
       ...
       <a href="../function/edit_profile4.php?id=<?php echo $objResult->id_std; ?>" class="btn btn-primary btn-xs">
                       แก้ไขประวัติ</a>
                
      <a href="../function/delete_std4.php?id=<?php echo $objResult->id_std; ?>" class="btn btn-danger btn-xs">
                       ลบข้อมูล</a>
